<table class="table table-responsive table-hover table-bordered">
    ...
    <?php //Showing all posts
        ...
        while ($row = mysqli_fetch_array($result)) 
        {
            ...
            echo "<td><a class='' href='comments.php?approve=$comment_id'>Approve</a></td>";  //sucess
            echo "<td><a class='' href='comments.php?unapprove=$comment_id'>Unapprove</a></td>"; //warninng
            echo "<td><a class='' href='comments.php?delete=$comment_id'>Delete</a></td>"; //danger
            echo "</tr>";
        }
    ?>
